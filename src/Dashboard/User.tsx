        ...
        <>
            <div className="w-full h-max flex">
                ...
                <div className="w-[73%] phone:w-full h-screen bg-[#042836] ">
                    <div className="w-full phone:fixed phone:top-0 phone:left-0 phone:z-[1001] h-20 flex items-center justify-between bg-[#003049] border-b border-b-gray-600 px-5">
                        <div
                            className="w-max h-max transition-all duration-500 hidden phone:flex items-center justify-center p-2 px-3 cursor-pointer hover:bg-[#e6306f] text-white rounded bg-[#535a94]"
                    ...
                    <div className="w-full h-[calc(100%-5rem)] phone:mt-20 overflow-y-auto scrollbar-none scrollbar-thumb-[#003049] scrollbar-track-[#042836] scrollbar-thin ">
            ...
            <Drawer
                ...
                className="p-0 m-0"
            >
                <div className="w-full h-full mt-20 bg-[#003049] overflow-y-auto scroll-smooth">
                    <div className="w-full h-max flex flex-col ">
                        <div className="w-full h-max flex flex-col gap-2 p-5 border-b border-b-gray-600">
                            <div className="w-full h-max rounded bg-gradient-to-r from-[#e52e71] to-[#ff8a00] p-3 flex flex-col gap-2">
                                <div className="w-full h-max flex justify-between">
                        ...
                        <div className="w-full h-max flex flex-col gap-3 p-7 transition-all duration-500" onClick={closeSideBar}>
                            <NavLink
                                to={"/user/dashboard"}
                                className={({isActive}) =>
                                    !isActive
